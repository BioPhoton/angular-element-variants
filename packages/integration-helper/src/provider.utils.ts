import {VariantConfig, CompilationTypes, ElementSet, ZoneHandling} from '@angular-element-variants/core';
...
export function createCustomElements<T>(variantConfig: VariantConfig, elements: ElementSet<T>, createFn: (componentClass: any) => any ): void {
